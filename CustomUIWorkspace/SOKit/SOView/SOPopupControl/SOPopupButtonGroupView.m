...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [collectionView registerClass:[SOPopupButtonCell class] forCellWithReuseIdentifier:cellIndentifier];
    SOPopupButtonCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellIndentifier forIndexPath:indexPath];
